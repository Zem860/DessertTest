    ...
    <>
      <div className="w-full md:w-[300px]">
        <div className=" w-full bg-cover bg-center aspect-square md:h-[315px] md:w-[300px] bg-[url('https://firebasestorage.googleapis.com/v0/b/potoro-5fe55.appspot.com/o/dessert%2Fp-2.png?alt=media&token=08c953bf-e5af-4ffa-870d-365c577e14ff')]">
            ...
            <Tag></Tag>
            <img className=" mt-3 mr-3 object-contain w-16 md:w-8"  src="https://firebasestorage.googleapis.com/v0/b/potoro-5fe55.appspot.com/o/dessert%2Ffavorite_border.png?alt=media&token=3a3972a7-4351-49b3-ac3e-ecfcb9946ab6" alt="favorite icon" />
            </div>
        </div>
        {/* <img
